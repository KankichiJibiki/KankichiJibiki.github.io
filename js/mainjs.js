  ...
  // *****----Beginning of Vocabraly----*****
{
  const vocaset = [
    ...
    {d:'5:May 16', 
    v:['gut (feeling/instinct/reaction)','get by','count someone out','on the go all day','make ends meet'],
    m:['','','','(一日中、動き回る）','']},
    {d:'6:May 17', 
    v:['thaw','get it together','on track','guts','-fold'],
    m:['','','','','']},
    {d:'7:May 18', 
    v:['molify','do out of spite','high-maintenance','Its so someone','devote oneself to'],
    m:['','','','','']},
    {d:'8:May 21', 
    ...
    m:['','','','','']},
    {d:'166:Dec 29', 
    v:['push forward','over-the-top','Rub off on','(get) stale','go-oriented'],
    m:['','','','','']},
    {d:'167:Dec 31', 
